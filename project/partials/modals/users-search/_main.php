        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <div id="kt_modal_users_search_handler" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="inline">
                    ...
                    <!--begin::Wrapper-->
                    <div class="py-5">
                        <?php include 'partials/modals/users-search/partials/_suggestions.php' ?>
                        <?php include 'partials/modals/users-search/partials/_results.php' ?>
                        <?php include 'partials/modals/users-search/partials/_empty.php' ?>
                    </div>
                    <!--end::Wrapper-->
                </div>
                <!--end::Search-->
